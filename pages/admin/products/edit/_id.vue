                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded shadow-sm border-top-orange">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-folder"></i> EDIT DATA PRODUCT</span>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div v-if="validation.category_id" class="mt-2">
                                                    <b-alert show variant="danger">{{ validation.category_id[0] }}
                                                    </b-alert>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div v-if="validation.discount" class="mt-2">
                                                    <b-alert show variant="danger">{{ validation.discount[0] }}
                                                    </b-alert>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    head() {
        return {
            title: 'Edit Data Product - Administrator',
        }
    },
    ...
    async asyncData({ store, route }) {
        await store.dispatch('admin/route_conflig_for_product/getListAllCategories')
    ...
    computed: {
        //categories
        categories() {
            return this.$store.state.admin.route_conflig_for_product.categories
        },
    },
    //mounted
    mounted() {
        ...
        this.product.content = this.$store.state.admin.product.product.content
