                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" v-model="search" @keypress.enter="searchData"
                                            class="form-control" placeholder="cari berdasarkan nama customer">
                                ...
                                <b-pagination align="left" :value="customers.current_page" :total-rows="customers.total"
                                    :per-page="customers.per_page" @change="changePage" aria-controls="my-table">
                                </b-pagination>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    async asyncData({ store }) {
        ...
        const stateProduct = await store.dispatch('admin/customer/getCustomersData')
        return { stateProduct }
    },
    computed: {
        customers() {
