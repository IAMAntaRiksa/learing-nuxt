            ...
            <div class="card h-100 border-0 rounded shadow-sm">
              <div class="card-body">
                <div class="card-img-actions">
                  <img :src="product.image" class="card-img img-fluid" width="100" height="100">
                </div>
              </div>
              <div class="card-body bg-light-custom text-center rounded-bottom">
                ...
                <h6 class="mb-0 font-weight-semibold"><s class="text-red">
                ...
                <client-only>
                  <vue-star-rating :rating="parseFloat(product.reviews_avg_rating)" :increment="0.5" :star-size="20"
                    :read-only="true" :show-rating="false" :inline="true">
                  </vue-star-rating>
