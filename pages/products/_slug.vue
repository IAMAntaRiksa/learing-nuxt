        ...
        <div class="fade-in">
                    ...
                    <div class="card border-0 rounded shadow-sm">
                        <div class="card-body">
                            ...
                            <button @click="addToCart(product.id, calculateDiscount(product), product.weight)"
                                class="btn btn-lg btn-warning border-0 shadow-sm"><i class="fa fa-shopping-cart"></i>
                                TAMBAH KE
                                KERANJANG</button>
                        </div>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card border-0 rounded shadow-sm">
                        <div class="card-body">
                            <h5><i class="fa fa-comments"></i> ULASAN PRODUK ( <strong>{{ product.reviews_count
                            }}</strong> ulasan )</h5>
                            <hr>
                            <div class="card bg-light shadow-sm rounded" v-for="review in product.reviews"
                                :key="review.id">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <div class="description mt-2">
                                                <span
                                                    style="color: rgb(119, 118, 118);font-size:15px;font-style:italic">
                                                    {{ review.review }}
                                                </span>
                                            </div>
                                        </div>
